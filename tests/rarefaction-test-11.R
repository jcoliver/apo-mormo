# Rarefaction test 11: Testing print frequency on 20 loci
# Jeff Oliver
...
test.data = list()
test.data$tab <- apo.str.genind@tab[pop.rows, 1:39]
test.data$loc.fac <- factor(apo.str.genind@loc.fac[1:39])
